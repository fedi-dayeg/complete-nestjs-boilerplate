# GitHub Copilot Instructions for Complete NestJS Boilerplate
...
Complete NestJS Boilerplate (v2.1.0+) is a comprehensive authentication and authorization service built with NestJS v11.x. It uses:
