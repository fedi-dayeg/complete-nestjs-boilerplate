...
# Contributing to Complete NestJS Boilerplate
...
2. **Clone** your fork locally
   ```bash
   git clone https://github.com/YOUR_USERNAME/complete-nestjs-boilerplate.git
   cd complete-nestjs-boilerplate
   ```
3. Add upstream remote
   ```bash
   git remote add upstream https://github.com/fedi-dayeg/complete-nestjs-boilerplate.git
   ```
...
[ref-good-first-issue]: https://github.com/fedi-dayeg/complete-nestjs-boilerplate/labels/good%20first%20issue
[ref-conventional-commits]: https://www.conventionalcommits.org/
[ref-discussions]: https://github.com/fedi-dayeg/complete-nestjs-boilerplate/discussions
