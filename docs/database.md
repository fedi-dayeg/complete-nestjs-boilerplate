...
> Since version `2.0.0`, This project now uses **Prisma ORM** as the primary database toolkit, replacing the previous Mongoose ODM approach. Prisma provides type-safe database access, modern query builder, and automatic migrations.
