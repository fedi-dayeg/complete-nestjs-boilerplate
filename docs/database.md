...
In Complete NestJS Boilerplate, you can use the `yarn db:migrate` script to quickly sync your schema to MongoDB.
...
> **Note**: Complete NestJS Boilerplate currently uses Prisma v6
...
In Complete NestJS Boilerplate, some adjustments are needed:
