...
> TODO: (v2) In the future will replace `nestjs-command` with `commander`

This documentation explains the features and usage of:
- **Migration Module**: Located at `src/migration/**`

This document covers the migration and seed functionality in the Complete NestJS Boilerplate project, explaining how database seeding works and how to use the migration commands.
