...
import { ApiKeyCreateDto } from '@modules/api-key/dtos/api-key.create.dto';
...
import { ApiKeyResetSerialization } from '@modules/api-key/serializations/api-key.reset.serialization';
